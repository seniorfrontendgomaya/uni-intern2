...
import { ArrowLeft, IndianRupee, Tag, Eye, EyeOff } from "lucide-react";
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 bg-background px-4 py-2.5 pr-11 text-sm outline-none transition focus:border-brand focus:ring-2 focus:ring-brand/20"
                />
                <button
                  type="button"
