...
export function GraduationEducationForm({ onSave, onClose, initialValues }: Props) {
  ...
  return (
    <div className="p-3 border-2 border-dashed border-gray-300 rounded max-w-md">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-bold text-gray-900">Graduation/ Post-graduation details</h3>
        <button
          type="button"
          onClick={onClose}
