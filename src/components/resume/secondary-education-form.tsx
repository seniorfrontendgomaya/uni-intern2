...
export function SecondaryEducationForm({ onSave, onClose, initialValues }: Props) {
  ...
  return (
    <div className="p-3 border-2 border-dashed border-gray-300 rounded max-w-md">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-bold text-gray-900">Secondary (X) details</h3>
        <button
          type="button"
          onClick={onClose}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            />
            <p id="year-hint" className="mt-0.5 text-xs text-gray-500">4-digit year (e.g. 2022)</p>
          </div>
