...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/university", icon: <Home className="h-4 w-4" /> },
  { label: "Students", href: "/university/students", icon: <Users className="h-4 w-4" /> },
  { label: "Resume List", href: "/university/resume-list", icon: <FileText className="h-4 w-4" /> },
  { label: "Profile", href: "/university/profile", icon: <UserCircle className="h-4 w-4" /> },
];
  ...
  return (
    <div className="h-screen overflow-hidden bg-background">
      ...
      <div className="h-full lg:grid lg:grid-cols-[240px_1fr]">
        <aside className="hidden h-full overflow-y-auto border-r bg-card/60 backdrop-blur lg:flex lg:flex-col lg:gap-8 lg:px-6 lg:py-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">University panel</p>
            </div>
          </div>
